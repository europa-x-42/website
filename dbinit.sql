...
CREATE TABLE Catalog (itemID BIGINT,name TEXT,description TEXT,catID INTEGER,price FLOAT,imageURL TEXT);
CREATE TABLE Categories (catID INTEGER,name TEXT,description TEXT);
